<template>
    <div class="dongnan">
        <div class="nan" :class="{macao: ismacao}">
            <button class="taiwan iconfont" @click="outrevise">&#xe7f5;</button>
            <div class="lingnan">
                <div>姓名：</div><div>{{this.$store.state.name2}}</div>
                <div>专业：</div><div>{{this.$store.state.class2}}</div>
            </div>
            <div class="jiangnan">
                <div>
                ...
                <div><i>具体说明：</i><textarea rows="8" cols="59" disabled="disabled" v-text="this.$store.state.reason2"></textarea></div>
                <div>
                    <button @click="chngemacao2">否决</button>
                    <i></i>
                    <button @click="agree2">同意</button>
                </div>
            </div>
        </div>
        <div class="zhong" :class="{macao: ismacao}">
            <button class="taiwan2 iconfont" @click="outrevise">&#xe7f5;</button>
            <div class="lingnan lingnan2">
                <div>姓名：</div><div>{{this.$store.state.name2}}</div><br>
                <div>专业：</div><div>{{this.$store.state.class2}}</div>
            </div>
            <div class="jiangnan2">
                <div>
                ...
                <div>请假时间：<input type="text" disabled="disabled" v-model="this.$store.state.apply_time2"></div>
                <div><i>具体说明：</i><textarea rows="8" cols="46" disabled="disabled" v-text="this.$store.state.reason2"></textarea></div>
                <div>
                    <button @click="chngemacao2">否决</button>
                    <i></i>
                    <button @click="agree2">同意</button>
        ...
        <div class="bei" :class="{macao: !ismacao}">
            ...
            <button @click="sendreject2">确定</button>
        </div>
    </div>
</template>
...
export default {
    data() {
        return {
            isActive: this.$store.state.type3,
            hasError: this.$store.state.type4,
            ismacao: false,
            veto_reason: ''
        }
    },
